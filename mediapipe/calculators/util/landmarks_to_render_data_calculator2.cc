...
#include "mediapipe/calculators/util/landmarks_to_render_data_calculator2.h"
...
absl::Status LandmarksToRenderDataCalculator2::GetContract(
...
absl::Status LandmarksToRenderDataCalculator2::Open(CalculatorContext* cc) {
...
absl::Status LandmarksToRenderDataCalculator2::Process(CalculatorContext* cc) {
...
REGISTER_CALCULATOR(LandmarksToRenderDataCalculator2);
}  // namespace mediapipe
